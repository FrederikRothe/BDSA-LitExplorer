...
public static class TestEntities {
    ...
    // Connections
    public static Connection testconn1 = new Connection(howToGetStronk,howToMakeFood,new List<ConnectionType>{ConnectionType.Author, ConnectionType.Tag, ConnectionType.Reference, ConnectionType.Other}, "Disse er sat sammen og dette er beskrivelsen.");
    ...
    public static Connection testconn3 = new Connection(hihihaha,howToMakeFood,new List<ConnectionType>{ConnectionType.Reference}, null);
